<!--
    Used to display an alert box with the contents given in parameters

    primaryText: The message you want to display in bold
    secondaryText: The optional message you want to display in normal font (default: "")
    closable: Should the box have a close button or not (default: true)
-->
